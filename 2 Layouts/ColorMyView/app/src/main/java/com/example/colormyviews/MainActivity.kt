...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeColored(view: View) {
        when (view.id) {
            ...
            //When passed view -> it will affect the item that was clicked,
            //When passed id of a resource -> will affect the resource with that id
    ...
    private fun setListeners() {
        ...
        //add all the controls instances to the list
