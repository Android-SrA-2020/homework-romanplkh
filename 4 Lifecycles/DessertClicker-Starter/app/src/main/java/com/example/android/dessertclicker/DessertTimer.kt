...
class DessertTimer(lifecycle:Lifecycle):LifecycleObserver {
    ...
    //Subscribe for parent lifecycle
    init {
        lifecycle.addObserver(this)
    }


    //How observer will be observing
    //WHEN PARENT WILL BE IN A STATE OF ON START CYCLE, PLEASE RUN THIS METHOD
    ...
    //How observer will be observing
    //WHEN PARENT WILL BE IN A STATE OF ON STOP CYCLE, PLEASE RUN THIS METHOD
